  ...
  return (
    <div className="h-screen w-full bg-white flex flex-col justify-center items-center px-6 text-center mt-5">
      <h1 className="text-2xl font-semibold mb-4">
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-700 text-6xl font-bold">
          27 million
        </span>
        <br />
      ...
      <button
        ...
        className="bg-gradient-to-r from-blue-500 to-blue-700 text-yellow-300 font-semibold py-2 px-6 rounded-full shadow-md hover:scale-105 transition w-full max-w-xs text-2xl"
      >
        Continue
      </button>
    </div>
